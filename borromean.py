...
def make_loop_numpy(P, axis):
    x, y, z = rotate_coords(P, axis)
    h = Lx / Nx
    eps = 0.01

    yb1, yb2 = -(4 + eps) * h, -(4 - eps) * h
    yt1, yt2 = (4 - eps) * h, (4 + eps) * h
    xl1, xl2 = -(2 + eps) * h, -(2 - eps) * h
    xr1, xr2 = (2 - eps) * h, (2 + eps) * h
    zl, zu = -eps * h, eps * h
